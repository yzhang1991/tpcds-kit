...
static int arFuncArgs[MAX_FUNC][MAX_ARGS + 1] =
        {
                ...
                /* KW_DIST */
                                     {EXPR_FL_CHAR,      EXPR_FL_TYPESHIFT, EXPR_FL_TYPESHIFT, 0},
                /* KW_LIST */
                                     {EXPR_FL_TYPESHIFT, EXPR_FL_INT, 0},
                /* KW_ULIST */
                                     {EXPR_FL_TYPESHIFT, EXPR_FL_INT, 0},
                /* KW_RANGE */
                                     {EXPR_FL_TYPESHIFT, EXPR_FL_INT, 0},
                /* KW_RANDOM */
                                     {EXPR_FL_INT,       EXPR_FL_INT,       EXPR_FL_INT,       0},
                /* KW_TEXT */
                                     {EXPR_FL_CHAR,      EXPR_FL_INT, 0},
                /* KW_ROWCOUNT */
                                     {EXPR_FL_CHAR, 0},
                /* KW_DISTMEMBER */
                                     {EXPR_FL_CHAR,      EXPR_FL_TYPESHIFT, EXPR_FL_TYPESHIFT, 0}, /* do the checking at runtime */
                /* KW_DISTWEIGHT */
                                     {EXPR_FL_CHAR,      EXPR_FL_TYPESHIFT, EXPR_FL_TYPESHIFT, 0} /* do the checking at runtime */
        };
...
MakeListExpr(int nModifier, expr_t *pExpr, int nArg) {
    ...
    switch (nModifier) {
        ...
        case KW_RANGE:
            ...
            break;
        default: INTERNAL("Bad modifier in MakeListExpr()");
            break;
    }
...
ValidateParams(int nFunc, expr_t *pArgs) {
    ...
    for (pCurrentArg = (expr_t *) getHead(pArgs->ArgList); pCurrentArg; pCurrentArg = (expr_t *) getNext(
            pArgs->ArgList)) {
