...
update s_catalog_returns_m
set cret_return_date = null
where cret_return_date like '%-47%';
create table crv as
...
from s_catalog_returns_m
         left outer join date_dim on (to_date(cret_return_date, 'YYYY-MM-DD') = d_date)
