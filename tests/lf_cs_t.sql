update s_catalog_order_m
set cord_order_date = ''
where cord_order_date = '-4713-11-2';
update s_catalog_order_lineitem_m
set clin_ship_date = ''
where clin_ship_date = '-4713-11-2';
...
from s_catalog_order_m
         left outer join date_dim d1 on (to_date(cord_order_date, 'YYYY-MM-DD') = d1.d_date)
