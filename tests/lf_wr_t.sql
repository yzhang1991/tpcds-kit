update s_web_returns_m
set wret_return_date = null
where wret_return_date like '%-47%';
drop table wrv;
create table wrv as
...
from s_web_returns_m
         left outer join date_dim on (to_date(wret_return_date, 'YYYY-MM-DD') = d_date)
